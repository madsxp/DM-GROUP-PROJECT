...
public class WeatherDay extends App.Data {
    ...
    public void set_relative_humidity(double data) {
    ...
    public double get_relative_humidity() {
        ...
        try {
            ...
            e.printStackTrace();
            System.err.println("Message: relative_humidity not set on WeatherDay id:" + this.id + " (" + this + ") RETURNED 0.0");
        }
        return value;
